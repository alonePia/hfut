...
public class StringUtil {
	...
	public static boolean isInArray(int value, String[] array) {
		if (array == null)
			return false;
		for (String v : array) {
		    Integer iv = NumberUtils.toInt(v,0);
...
/*	public static String getRootPath(String resource) {
	 ...
	 * @throws Exception
	 */
	public static String getRandNumber6() throws Exception{
            Random rands = new Random();
            int x = rands.nextInt(899999);
            x = x + 100000;
            return x+"";
	}
     ...
     * @throws Exception
     */
    public static String escapeStr (String keyword){
